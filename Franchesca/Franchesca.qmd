...
regime_change_freq <- democracy_data |>
  ...
  filter((year == min(year) 
          & regime_category != post_regime) | 
           regime_category != post_regime)  |>
  mutate(regime_category = ifelse(
    regime_category %in% c("Parliamentary democracy",
                           "Mixed democratic",
    ...
    "Other"),
    post_regime = ifelse(
    post_regime %in% c("Parliamentary democracy",
                           "Mixed democratic",
                           "Presidential democracy",
                           "Civilian dictatorship",
                           "Military dictatorship",
...
# reordering regime categories based on democratic to dictatorial
